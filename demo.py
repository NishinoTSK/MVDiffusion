...
if args.image_path is None:
    ...
    model.load_state_dict(torch.load('weights/pano.ckpt', map_location='cpu')['state_dict'], strict=False)
    ...
    model.load_state_dict(torch.load('weights/pano_outpaint.ckpt', map_location='cpu')['state_dict'], strict=False)
